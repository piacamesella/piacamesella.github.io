                ...
                <div  class="list-comments-item">
                    <div class="row">
                        <div class="col">
                            ...
                            <h4 class="mb-1">${products.user} <small class="text-muted"> - ${products.dateTime} - </small> ${estrellas(products.score)}</h4><br><small class="text-muted">${products.description}</small>
                        </div>
                    </div>
                </div>
                `
