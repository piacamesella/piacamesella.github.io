...
document.addEventListener("DOMContentLoaded", function(){
    if(localStorage.getItem("datosPerfil")==null){
        document.getElementById("emailID").value=localStorage.getItem("usuario") && inputNombre.value=="" && inputSegundoNombre.value=="" && inputApellido.value=="" && inputSegundoApellido.value=="" && inputTel.value=="";
    }else{
